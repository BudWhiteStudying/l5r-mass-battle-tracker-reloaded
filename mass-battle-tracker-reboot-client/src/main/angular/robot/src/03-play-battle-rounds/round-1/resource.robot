...
Navigation to Leader Selection Page Should Succeed
    ...
    ...    first-move-next-button
    ...    leader-selection-main-card
    ...    leader-selection
...
Register First Army First Leader Action
    ...
    ...    ${FIRST ARMY FIRST LEADER ACTION NAME}
    ...    ${FIRST ARMY FIRST LEADER ATTR CAUSED}
    ...    ${FIRST ARMY FIRST LEADER PANIC CAUSED}
    ...    ${FIRST ARMY FIRST LEADER PANIC REMOVED}

Register Second Army First Leader Action
    Register Leader Action
    ...    ${SECOND ARMY FIRST LEADER ACTION NAME}
    ...    ${SECOND ARMY FIRST LEADER ATTR CAUSED}
    ...    ${SECOND ARMY FIRST LEADER PANIC CAUSED}
    ...    ${SECOND ARMY FIRST LEADER PANIC REMOVED}

Register Second Army Second Leader Action
    Register Leader Action
    ...    ${SECOND ARMY SECOND LEADER ACTION NAME}
    ...    ${SECOND ARMY SECOND LEADER ATTR CAUSED}
    ...    ${SECOND ARMY SECOND LEADER PANIC CAUSED}
    ...    ${SECOND ARMY SECOND LEADER PANIC REMOVED}
...
Navigation to Next Round Page Should Succeed
    Navigation to Page Should Succeed
    ...    round-summary-next-button
    ...    objective-selection-main-card
    ...    objective-selection
